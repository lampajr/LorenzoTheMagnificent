package client.main_client.GUI.game_view;
...
import client.main_client.GUI.game_view.alert.GameEndedAlert;
...
public class GUIController implements InterfaceController {
    ...
    public void createOpponentDiscs(int id, String name) {
        ...
        Platform.runLater(() -> {
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("client/main_client/GUI/game_view/personal_board_view.fxml"));
...
//        lorenzoAnimation.startGameAnimation();
        ...
        try {
            ...
            fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("client/main_client/GUI/game_view/personal_board_view.fxml"));
            Parent personalBoard = fxmlLoader.load();
